...
function pushSphere(points, p, r, c) {
  if (points.positions == undefined) {
    points.positions = [];
    points.colors = [];
    points.normals = [];
  }
  for (var latitude = -Math.PI/2.; latitude < Math.PI/2.; latitude += Math.PI/10.) {
    for (var longitude = 0; longitude < Math.PI*2.; longitude += Math.PI/10.) {
      points.positions.push(r * Math.cos(longitude) * Math.cos(latitude) + p[0]);
      points.positions.push(r * Math.sin(latitude) + p[1]);
      points.positions.push(-r * Math.sin(longitude) * Math.cos(latitude) + p[2]);
      points.normals.push(Math.cos(longitude) * Math.cos(latitude));
      points.normals.push(Math.sin(latitude));
      points.normals.push(-Math.sin(longitude) * Math.cos(latitude));

      points.positions.push(r * Math.cos(longitude + Math.PI/10.) * Math.cos(latitude) + p[0]);
      points.positions.push(r * Math.sin(latitude) + p[1]);
      points.positions.push(-r * Math.sin(longitude + Math.PI/10.) * Math.cos(latitude) + p[2]);
      points.normals.push(Math.cos(longitude + Math.PI/10.) * Math.cos(latitude));
      points.normals.push(Math.sin(latitude));
      points.normals.push(-Math.sin(longitude + Math.PI/10.) * Math.cos(latitude));

      points.positions.push(r * Math.cos(longitude + Math.PI/10.) * Math.cos(latitude + Math.PI/10.) + p[0]);
      points.positions.push(r * Math.sin(latitude + Math.PI/10.) + p[1]);
      points.positions.push(-r * Math.sin(longitude + Math.PI/10.) * Math.cos(latitude + Math.PI/10. + p[2]));
      points.normals.push(Math.cos(longitude + Math.PI/10.) * Math.cos(latitude + Math.PI/10.));
      points.normals.push(Math.sin(latitude + Math.PI/10.));
      points.normals.push(-Math.sin(longitude + Math.PI/10.) * Math.cos(latitude + Math.PI/10.));
      ...
      points.positions.push(r * Math.cos(longitude) * Math.cos(latitude + Math.PI/10.) + p[0]);
      points.positions.push(r * Math.sin(latitude + Math.PI/10.) + p[1]);
      points.positions.push(-r * Math.sin(longitude) * Math.cos(latitude + Math.PI/10.) + p[2]);
      points.normals.push(Math.cos(longitude) * Math.cos(latitude + Math.PI/10.));
      points.normals.push(Math.sin(latitude + Math.PI/10.));
      points.normals.push(-Math.sin(longitude) * Math.cos(latitude + Math.PI/10.));
